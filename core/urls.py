...
urlpatterns = [
    ...
    path('departamentos/update/<int:pk>/', DepartamentosUpdate.as_view(), name='departamentos_update'),
    path('departamentos/delete/<int:pk>/', DepartamentosDelete.as_view(), name='departamentos_delete'),
